...
class GesturePublisher(Node):
    ...
    def timer_callback(self):
        msg = String()
        msg.data = self.keypoint_classifier_labels[self.hand_sign_id]
        ...
        while True:
            ...
            if results.multi_hand_landmarks is not None:
                for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                    ...
                    self.most_common_fg_id = Counter(
                    ...
                    debug_image = self.draw_info_text(
                        ...
                        brect,
                        handedness,
                        self.keypoint_classifier_labels[self.hand_sign_id],
                        self.point_history_classifier_labels[self.most_common_fg_id[0][0]],
                    )
                    print(self.keypoint_classifier_labels[self.hand_sign_id])
                    print(self.point_history_classifier_labels[self.most_common_fg_id[0][0]])
            ...
            ################################################################################
            # msg.data = self.keypoint_classifier_labels[self.hand_sign_id]
            # pub = gesture_node.create_publisher(msg, 'gesture',10)
            # pub.publish(msg)
            ...
            #           self.point_history_classifier_labels[self.most_common_fg_id[0][0]](publish)
            ...
            msg = String()
            msg.data = self.keypoint_classifier_labels[self.hand_sign_id]
            gesture_publisher.publish(msg)


            # rp.spin(gesture_publisher)
    ...
    def draw_landmarks(self, image, landmark_point):
        ...
        for index, landmark in enumerate(landmark_point):
            ...
            if index == 5:   # Index Finger mcp
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 6:   # Index Finger pip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 7:   # Index Finger dip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 8:   # Index Finger tip
                cv.circle(image, (landmark[0], landmark[1]), 8, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 8, (0, 0, 0), 1)
            if index == 9:   # Middle Finger mcp
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 10:  # Middle Finger pip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 11:  # Middle Finger dip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 12:  # Middle Finger tip
                cv.circle(image, (landmark[0], landmark[1]), 8, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 8, (0, 0, 0), 1)
            if index == 13:  # Ring Finger mcp
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 14:  # Ring Finger pip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 15:  # Ring Finger dip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 16:  # Ring Finger tip
                cv.circle(image, (landmark[0], landmark[1]), 8, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 8, (0, 0, 0), 1)
            if index == 17:  # Pinky mcp
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 18:  # Pinky pip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
            if index == 19:  # Pinky dip
                cv.circle(image, (landmark[0], landmark[1]), 5, (255, 255, 255),
                        -1)
                cv.circle(image, (landmark[0], landmark[1]), 5, (0, 0, 0), 1)
